      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#1E2937] rounded-3xl p-8 shadow-2xl border border-gray-700">
          ...
          <div className="space-y-6">
            ...
            >
              Đăng nhập$ npx tailwindcss init -p npm error could not determine
              executable to run npm error A complete log of this run can be
              found in:
              C:\Users\Kuuga\AppData\Local\npm-cache\_logs\2026-03-12T03_49_46_461Z-debug-0.log
            </Button> */}
